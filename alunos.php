...
<div class="row">
    <!-- BOTÃO CADASTRO -->
    <a type="button" class="" href="alunos-cadastro.php">Novo Aluno</a>
                ...
                <?php 
                   ...
                   for ($i=0; $i < count($res); $i++) { 
                    ...
                    <tr>
                        ...
                        <!-- BOTOES DE AÇÃO -->
                        <td>
                             <a href="alunos-cadastro.php?funcao=editar&id=<?php echo $id ?>" ><i class='fa fa-edit'></i></a>
                             <a href="?funcao=excluir&id=<?php echo $id ?>"class="ml-2 text-danger" ><i class='fa fa-trash'></i></a>
                             <a href="turmas-alunos.php?funcao=turma&id=<?php echo $id ?>"class="ml-2 text-success" ><i class='fa fa-users'></i></a>
